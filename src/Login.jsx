    ...
    return (
        ...
        <div className='text-white h-[100vh] flex justify-center items-center bg-cover'>
            <div className= "bg-purple-800 border border-slate-400 rounded-md p-10 shadow-lg backrop-filter backdrop-blur-sm bg-opacity-80 relative"  >
                <h1 className="text-4xl text-white font-bold text-center mb-10">Login</h1>
                <form action="">
                ...
                <label htmlFor="" className="absolute text-lg text-white duration-300 transform -translate-y-6 scale-75 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-white-600 peer-focus:dark:text-white-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8">Your Password</label>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <Link to = '' className="text-pink-200">Forgot Password?</Link>
                </div>
                <button type="submit" className="w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-purple-800 font-bold hover:bg-pink-600 hover:text-white py-2 transition-colors"><Link to='/'>Login </Link></button>
                <div>
                    <span className="m-2">New Here? <Link className= "text-pink-200" to='/Register'> Create an Account</Link></span>
                </div>
                </form>
            </div>
        </div>
